  ...
  public criarTabelas(db: SQLiteObject) {
    ...
    return new Promise((resolve, reject) => {
      db.transaction(tx => {
        ...
        promisesTx.push(new Promise((resolve, reject) => { tx.executeSql('CREATE TABLE IF NOT EXISTS pagamentoMensalistas (Id integer primary key AUTOINCREMENT NOT NULL, IdMovimento integer NOT NULL, IdMensalista integer NOT NULL, Inicio Date, Fim Date)', [], () => resolve(), (erro) => reject(erro))} ))
